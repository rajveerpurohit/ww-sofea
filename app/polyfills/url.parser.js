    ...
    (function () {
      ...
      function urlencoded_serialize(pairs) {
        let output = '',
          first = true;
        pairs.forEach((pair) => {
          const name = encodeURIComponent(pair.name);
      ...
      function URL(url, base) {
        ...
        const instance = URLUtils(url || '');

        // Detect for ES5 getter/setter support
        // (an Object.defineProperties polyfill that doesn't support getters/setters may throw)
        const ES5_GET_SET = (function () {
        ...
        const self = ES5_GET_SET ? this : document.createElement('a');

        const query_object = new URLSearchParams(instance.search ? instance.search.substring(1) : null);
        ...
        Object.defineProperties(self, {
          ...
          host: {
            get() {
              ...
              const re = { 'http:': /:80$/, 'https:': /:443$/, 'ftp:': /:21$/ }[instance.protocol];
