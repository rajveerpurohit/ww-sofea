                  ...
                  <div className="wfs-features__block">
                    ...
                    <p className="text-small">
                      ...
                      <span className="icon-para__paragraph">As a WoolworthsBlack Credit Cardholder, you'll get free online delivery when you shop on
                        <a href="#">www.woolworths.co.za</a>. You will need to save your Black Credit Card against your online profile in order to activate this benefit.
                      </span>
                    </p>
                  </div>
                  <div className="wfs-features__block">
                  ...
                  <div className="wfs-features__block">
                    ...
                    <p className="text-small">
                      ...
                      <span className="icon-para__paragraph">As a Woolworths Credit Cardholder, you're automatically part of our great
                        <a href="#">WRewards programme</a> that offers you exclusive special lower prices and exciting benefits. With a Woolworths Black Credit Card, you'll automatically receive
