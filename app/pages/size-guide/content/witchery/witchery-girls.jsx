...
class WitcheryGirls extends Component {
  render() {
    return(
      <div className="page-layout__content">
        ...
        <div id="girls" className="cardFormWrapper grid-visible">
          <aside>
                <div className="accordion__segment--chrome accordion__segment is-collapsed" data-js="accordion-segment">
                  ...
                  <div data-js="accordion-content" className="accordion__content--chrome accordion__content is-collapsed">
                      <div className="grid size-guide-measurements">
                        ...
                        <img alt="sizing guides measurement" src="/images/content/size_guides/wt_girls.gif" width="100%" />
                        <div className="grid counter">
                            ...
                            <p className="text-small">Measured at the widest part of the bust protrusion. Pass the tape over the nipples, under the arms and around the back, keeping 
                              it horizontal to the ground all the way around.
                            </p>
