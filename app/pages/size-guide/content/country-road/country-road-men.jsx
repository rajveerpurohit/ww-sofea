...
class CountryRoadMen extends Component {
  render() {
    return(
      <div className="page-layout__content">
        ...
        <div id="men" className="cardFormWrapper grid-visible">
        <aside>
            <div className="accordion__segment--chrome accordion__segment is-collapsed" data-js="accordion-segment">
              ...
              <div data-js="accordion-content" className="accordion__content--chrome accordion__content is-collapsed">
                  <div className="grid size-guide-measurements">
                    ...
                    <img alt="sizing guides measurement" src="/images/content/size_guides/cr_men.gif" width="100%"/>
                    <div className="grid counter">
                        ...
                        <p className="text-small">Decide where you want your trousers to sit (on the hips, above the hips) and measure at this position. Ensure that the tape is horizontal to 
                          the ground.
                        </p>
            ...
            <div className="grid grid__two-thirds--large">
                ...
                <div className="grid grid--space-y grid__half--medium">
