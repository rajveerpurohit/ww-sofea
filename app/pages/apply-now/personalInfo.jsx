...
import SubmitPersonalInfoForm from '../../components/basic/apply-now-online/SubmitPersonalInfoForm';
        ...
        <main className="grid grid--space-y site-main">
          <div className="grid grid--space-y wfs-app">
            ...
            <ul className="nav-list-x progress">
              ...
              <li className="progress__step progress__step--current"><span className="icon icon--wfs-app-step-current" /><span className="progress__label text-medium"> {ServiceUtil.getLabel(this.props.labels, 'global-wfs-personal-info-label')}</span></li>
              <li className="progress__step"><span className="icon icon--wfs-app-step-incomplete" /><span className="progress__label text-medium"> {ServiceUtil.getLabel(this.props.labels, 'global-wfs-income-expenses-label')}</span></li>
            ...
            <SubmitPersonalInfoForm labels={this.props.labels} />
          </div>
        </main>
      </div>
    );
